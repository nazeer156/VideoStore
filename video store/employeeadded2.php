...
$sql="INSERT INTO hourly (EmployeeId, Name, Address, Phone)
VALUES ('$employeeid', '$name', '$address', '$phone')";

$sql1 ="INSERT INTO hworks (EmployeeId, StoreId, Rate)
VALUES ('$employeeid', '$storeid', '$rate')";
